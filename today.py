...
USER_NAME = os.environ['USER_NAME'] # 'Qodarrz'
...
if __name__ == '__main__':
    """
    Muhammad Heidar Arrizqie (Qodarrz), 2026
    """
    print('Calculation times:')
    # define global variable for owner ID and calculate user's creation date
    # e.g {'id': '...'} and 2019-11-03T21:15:07Z for username 'Qodarrz'
    ...
    if OWNER_ID == {'id': 'MDQ6VXNlcjU3MzMxMTM0'}: # only calculate for user Qodarrz
