...
```text
ARCHITECTURE          Service boundaries, REST APIs, microservices, and maintainable codebases
REAL-TIME SYSTEMS     MQTT, Socket.IO, event-driven data flow, live monitoring dashboards
IOT INTEGRATION       ESP32 devices, sensors, cloud connectivity, hardware–software coordination
QUALITY & DELIVERY    Requirements, testing, debugging, deployment, and iterative improvement
```

## Application Engineering

```text
WEB APPLICATIONS      Responsive interfaces with Next.js, React, Vue.js, and TypeScript
BACKEND SERVICES      Express.js, FastAPI, Laravel, Fiber, Gin, and NestJS
MOBILE DEVELOPMENT    Cross-platform applications with Flutter
AUTOMATION            Practical workflows, browser testing, and operational tooling
```

## Security & Design

```text
APPLICATION SECURITY  Threat-aware development, access control, and secure system habits
