...
<tspan x="390" y="310" class="cc">. </tspan><tspan class="key">Expertise</tspan>.<tspan class="key">Domain</tspan>:<tspan class="cc"> .......... </tspan><tspan class="value">Web, App, IoT, Cysec</tspan>
<tspan x="390" y="330" class="cc">. </tspan><tspan class="key">Expertise</tspan>.<tspan class="key">SoftSkills</tspan>:<tspan class="cc"> ...... </tspan><tspan class="value">Teamwork, Problem Solving</tspan>
<tspan x="390" y="350" class="cc">. </tspan>
<tspan x="390" y="370" class="cc">. </tspan><tspan class="key">Hobbies</tspan>.<tspan class="key">Hardware</tspan>:<tspan class="cc"> .......... </tspan><tspan class="value">Custom OS, IoT Prototyping</tspan>
<tspan x="390" y="390" class="cc">. </tspan><tspan class="key">Hobbies</tspan>.<tspan class="key">Software</tspan>:<tspan class="cc"> .......... </tspan><tspan class="value">Web Dev, App, Bug Bounty</tspan>
<tspan x="390" y="410" class="cc">. </tspan>
<tspan x="390" y="430" class="cc">- </tspan><tspan>Contact</tspan> -——————————————————————————————————————————————-—-
<tspan x="390" y="450" class="cc">. </tspan><tspan class="key">Email</tspan>:<tspan class="cc"> ..................... </tspan><tspan class="value">heidararizki@gmail.com</tspan>
<tspan x="390" y="470" class="cc">. </tspan><tspan class="key">Phone</tspan>:<tspan class="cc"> ..................... </tspan><tspan class="value">+62 857-7364-3862</tspan>
<tspan x="390" y="490" class="cc">. </tspan><tspan class="key">LinkedIn</tspan>:<tspan class="cc"> .................. </tspan><tspan class="value">in/muhammadheidararrizqie</tspan>
<tspan x="390" y="510" class="cc">. </tspan><tspan class="key">Portfolio</tspan>:<tspan class="cc"> ................. </tspan><tspan class="value">https://heidar.my.id</tspan>
<tspan x="390" y="530" class="cc">. </tspan><tspan class="key">GitHub</tspan>:<tspan class="cc"> .................... </tspan><tspan class="value">Qodarrz</tspan>
<tspan x="390" y="550" class="cc">. </tspan>
<tspan x="390" y="570" class="cc">- </tspan><tspan>GitHub Stats</tspan> -—————————————————————————————————————————-—-
<tspan x="390" y="590" class="cc">. </tspan><tspan class="key">Repos</tspan>:<tspan class="cc" id="repo_data_dots"> .... </tspan><tspan class="value" id="repo_data">95</tspan> {<tspan class="key">Contributed</tspan>: <tspan class="value" id="contrib_data">133</tspan>} | <tspan class="key">Stars</tspan>:<tspan class="cc" id="star_data_dots"> ........... </tspan><tspan class="value" id="star_data">342</tspan>
<tspan x="390" y="610" class="cc">. </tspan><tspan class="key">Commmits</tspan>:<tspan class="cc" id="commit_data_dots"> ................. </tspan><tspan class="value" id="commit_data">2,116</tspan> | <tspan class="key">Followers</tspan>:<tspan class="cc" id="follower_data_dots"> ....... </tspan><tspan class="value" id="follower_data">196</tspan>
<tspan x="390" y="630" class="cc">. </tspan><tspan class="key">Lines of Code on GitHub</tspan>:<tspan class="cc" id="loc_data_dots">. </tspan><tspan class="value" id="loc_data">446,276</tspan> ( <tspan class="addColor" id="loc_add">523,178</tspan><tspan class="addColor">++</tspan>, <tspan id="loc_del_dots"> </tspan><tspan class="delColor" id="loc_del">76,902</tspan><tspan class="delColor">--</tspan> )
</text>'''
    ...
    new_content = re.sub(r'<svg(.*?)height="530px"', r'<svg\1height="680px"', new_content)
    # Update height in <rect> tag
    new_content = re.sub(r'<rect(.*?)height="530px"', r'<rect\1height="680px"', new_content)
